    ...
    return (
      <div style={{backgroundImage: 'url('+this.props.images[0].url+')'}} className="eventBox paper" onClick={this.props.onClick}>
        <div className="eventTextBox">
          ...
          <div className="info1">{this.props._embedded.venues[0].address.line1} {this.props._embedded.venues[0].city.name} {this.props._embedded.venues[0].country.name}</div>
          <div className="info1">$ {this.props.priceRanges[0].min}</div>
